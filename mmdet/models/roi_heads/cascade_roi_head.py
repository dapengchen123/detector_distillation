...
class CascadeRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def forward_train(self,
        ...
        for j in range(self.num_stages):
            ...
            bbox_results = self._bbox_forward_train(j,
                                                    x,
                                                    img,
                                                    img_no_normalize,
                                                    sampling_results,
            ...
            if j < self.num_stages - 1:
                ...
                with torch.no_grad():
                    ## change the background class to the second largest class
    ...
    def _bbox_forward_train(self,
        ...
        bbox_targets = self.bbox_head[stage].get_targets(sampling_results, gt_bboxes, gt_labels, train_cfg)
